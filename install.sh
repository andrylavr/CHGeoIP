...
cp GeoLite2-Country-Blocks-IPv4.json /opt/dictionaries/GeoLite2-Country-Blocks-IPv4.json
cp GeoLite2-Country-Locations-en.json /opt/dictionaries/GeoLite2-Country-Locations-en.json